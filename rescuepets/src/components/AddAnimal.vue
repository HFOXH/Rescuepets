        ...
        <v-expansion-panel-content>
          ...
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-checkbox
              ...
              label="Estas de a cuerdo con nuestras politicas y condiciones?"
              required
            ></v-checkbox>
            ...
            <v-btn
              style="background-color: rgb(230, 0, 0); color: #fff"
              @click="reset"
            >
              Cancelar
            </v-btn>
...
export default {
  ...
  methods: {
    validate() {
      ...
      this.valid = !this.$refs.form.hasError;
    },
    reset() {
      this.$refs.form.reset();
    },
    postAnimal() {
      console.log(this.selectTamanio)
